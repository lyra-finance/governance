...
async function main(): Promise<void> {
  ...
  const LYRA_STAKING_PROXY = "0x54D59c4596C7Ea66fD62188Ba1E16Db39E6F5472";

  const c = new ethers.Contract(LYRA_STAKING_PROXY, abi, deployer);

  console.log(JSON.stringify(abi));

  // console.log(await c.totalSupply());
  console.log(await c.EMISSION_MANAGER());

  console.log([
    {
      emissionPerSecond: 0,
      totalStaked: (await c.totalSupply()).toString(),
  ...
  //   {
  //     emissionPerSecond: "1" + "0".repeat(18),
